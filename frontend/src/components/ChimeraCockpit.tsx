...
const ChimeraCockpit: React.FC = () => {
  ...
  // Get API base URL. Only honor REACT_APP_API_URL on local dev; otherwise use relative /api
  ...
  const API_BASE_URL = isLocalHost && RAW_API_HOST ? (RAW_API_HOST.endsWith('/api') ? RAW_API_HOST : `${RAW_API_HOST}/api`) : DEFAULT_BASE;
